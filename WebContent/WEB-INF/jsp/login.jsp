								...
								<div id="signup_container">
									<form method="post" id="sign_up_form" action="signup">
										<div class="form-group">
											...
											<input type="password" class="form-control" id="password" name="password-repeat" placeholder="Password Repeat">
											...
											<div class="radio">
												...
												<label class="radio-inline">
													<input type="radio" id="grade" name="grade" value="4">4학년
												</label>
											</div>
											<input type="text" class="form-control" id="student_nuumber" name="studentNumber" placeholder="studentNumber">
											<input type="text" class="form-control" id="user_email" name="userEmail" placeholder="email">
